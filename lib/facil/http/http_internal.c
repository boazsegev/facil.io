...
FIOBJ HTTP_HEADER_WS_SEC_PROTOCOL;
...
FIOBJ HTTP_HVALUE_WS_SEC_PROTOCOL;
...
#define HTTPLIB_RESET(x)                                                       \
  ...
  HTTPLIB_RESET(HTTP_HEADER_WS_SEC_PROTOCOL);
  ...
  HTTPLIB_RESET(HTTP_HVALUE_WS_SEC_PROTOCOL);
...
static void http_lib_init(void *ignr_) {
  ...
  HTTP_HEADER_WS_SEC_PROTOCOL = fiobj_str_new("sec-websocket-protocol", 22);
  ...
  fiobj_obj2hash(HTTP_HEADER_WS_SEC_PROTOCOL);
