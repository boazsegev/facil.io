...
Verification value 0x2E6E523C : PASS
...
Alignment  7 -  5.812 bytes/cycle - 16627.37 MiB/sec @ 3 ghz
Alignment  6 -  5.156 bytes/cycle - 14751.53 MiB/sec @ 3 ghz
Alignment  5 -  5.837 bytes/cycle - 16699.07 MiB/sec @ 3 ghz
Alignment  4 -  5.786 bytes/cycle - 16552.47 MiB/sec @ 3 ghz
Alignment  3 -  5.576 bytes/cycle - 15953.71 MiB/sec @ 3 ghz
Alignment  2 -  5.811 bytes/cycle - 16626.01 MiB/sec @ 3 ghz
Alignment  1 -  5.676 bytes/cycle - 16239.77 MiB/sec @ 3 ghz
Alignment  0 -  5.969 bytes/cycle - 17077.75 MiB/sec @ 3 ghz
Average      -  5.703 bytes/cycle - 16315.96 MiB/sec @ 3 ghz

Small key speed test -    1-byte keys -    22.25 cycles/hash
...
Small key speed test -    5-byte keys -    24.99 cycles/hash
Small key speed test -    6-byte keys -    24.99 cycles/hash
Small key speed test -    7-byte keys -    25.00 cycles/hash
Small key speed test -    8-byte keys -    31.00 cycles/hash
Small key speed test -    9-byte keys -    31.46 cycles/hash
Small key speed test -   10-byte keys -    31.00 cycles/hash
Small key speed test -   11-byte keys -    31.45 cycles/hash
Small key speed test -   12-byte keys -    31.00 cycles/hash
Small key speed test -   13-byte keys -    31.46 cycles/hash
Small key speed test -   14-byte keys -    31.20 cycles/hash
Small key speed test -   15-byte keys -    31.29 cycles/hash
Small key speed test -   16-byte keys -    31.00 cycles/hash
Small key speed test -   17-byte keys -    31.45 cycles/hash
Small key speed test -   18-byte keys -    31.00 cycles/hash
Small key speed test -   19-byte keys -    31.00 cycles/hash
Small key speed test -   20-byte keys -    31.85 cycles/hash
Small key speed test -   21-byte keys -    31.33 cycles/hash
Small key speed test -   22-byte keys -    31.22 cycles/hash
Small key speed test -   23-byte keys -    31.00 cycles/hash
Small key speed test -   24-byte keys -    33.47 cycles/hash
Small key speed test -   25-byte keys -    31.57 cycles/hash
Small key speed test -   26-byte keys -    31.23 cycles/hash
Small key speed test -   27-byte keys -    31.14 cycles/hash
Small key speed test -   28-byte keys -    31.29 cycles/hash
Small key speed test -   29-byte keys -    31.52 cycles/hash
Small key speed test -   30-byte keys -    31.54 cycles/hash
Small key speed test -   31-byte keys -    31.00 cycles/hash
Average                                    29.749 cycles/hash
...
Testing  32-bit keys ->  64-bit hashes,   300000 reps.......... worst bias is 0.606667%
Testing  40-bit keys ->  64-bit hashes,   300000 reps.......... worst bias is 0.634667%
Testing  48-bit keys ->  64-bit hashes,   300000 reps.......... worst bias is 0.706000%
Testing  56-bit keys ->  64-bit hashes,   300000 reps.......... worst bias is 0.712000%
Testing  64-bit keys ->  64-bit hashes,   300000 reps.......... worst bias is 0.688667%
Testing  72-bit keys ->  64-bit hashes,   300000 reps.......... worst bias is 0.700667%
...
Testing  96-bit keys ->  64-bit hashes,   300000 reps.......... worst bias is 0.814000%
Testing 104-bit keys ->  64-bit hashes,   300000 reps.......... worst bias is 0.732000%
Testing 112-bit keys ->  64-bit hashes,   300000 reps.......... worst bias is 0.663333%
Testing 120-bit keys ->  64-bit hashes,   300000 reps.......... worst bias is 0.668667%
Testing 128-bit keys ->  64-bit hashes,   300000 reps.......... worst bias is 0.790000%
Testing 136-bit keys ->  64-bit hashes,   300000 reps.......... worst bias is 0.684667%
Testing 144-bit keys ->  64-bit hashes,   300000 reps.......... worst bias is 0.756000%
Testing 152-bit keys ->  64-bit hashes,   300000 reps.......... worst bias is 0.809333%

[[[ Keyset 'Cyclic' Tests ]]]

Keyset 'Cyclic' - 8 cycles of 8 bytes - 10000000 keys
Testing collisions   - Expected     0.00, actual     0.00 ( 0.00x)
Testing distribution - Worst bias is the  20-bit window at bit  45 - 0.042%
...
Testing collisions   - Expected     0.00, actual     0.00 ( 0.00x)
Testing distribution - Worst bias is the  20-bit window at bit  61 - 0.034%
...
Testing collisions   - Expected     0.00, actual     0.00 ( 0.00x)
Testing distribution - Worst bias is the  20-bit window at bit  24 - 0.044%
...
Testing collisions   - Expected     0.00, actual     0.00 ( 0.00x)
Testing distribution - Worst bias is the  20-bit window at bit  45 - 0.056%
...
Testing collisions   - Expected     0.00, actual     0.00 ( 0.00x)
Testing distribution - Worst bias is the  17-bit window at bit  52 - 0.093%

Keyset 'Sparse' - 40-bit keys with up to 6 bits set - 4598479 keys
Testing collisions   - Expected     0.00, actual     0.00 ( 0.00x)
Testing distribution - Worst bias is the  19-bit window at bit  43 - 0.047%

Keyset 'Sparse' - 48-bit keys with up to 5 bits set - 1925357 keys
Testing collisions   - Expected     0.00, actual     0.00 ( 0.00x)
Testing distribution - Worst bias is the  18-bit window at bit  21 - 0.051%

Keyset 'Sparse' - 56-bit keys with up to 5 bits set - 4216423 keys
Testing collisions   - Expected     0.00, actual     0.00 ( 0.00x)
Testing distribution - Worst bias is the  19-bit window at bit  44 - 0.070%

Keyset 'Sparse' - 64-bit keys with up to 5 bits set - 8303633 keys
Testing collisions   - Expected     0.00, actual     0.00 ( 0.00x)
Testing distribution - Worst bias is the  20-bit window at bit  31 - 0.041%

Keyset 'Sparse' - 96-bit keys with up to 4 bits set - 3469497 keys
Testing collisions   - Expected     0.00, actual     0.00 ( 0.00x)
Testing distribution - Worst bias is the  19-bit window at bit   4 - 0.071%

Keyset 'Sparse' - 256-bit keys with up to 3 bits set - 2796417 keys
Testing collisions   - Expected     0.00, actual     0.00 ( 0.00x)
Testing distribution - Worst bias is the  19-bit window at bit  53 - 0.105%

Keyset 'Sparse' - 2048-bit keys with up to 2 bits set - 2098177 keys
Testing collisions   - Expected     0.00, actual     0.00 ( 0.00x)
Testing distribution - Worst bias is the  18-bit window at bit  46 - 0.054%
...
Keyset 'Combination' - up to 8 blocks from a set of 8 - 19173960 keys
Testing collisions   - Expected     0.00, actual     0.00 ( 0.00x)
Testing distribution - Worst bias is the  19-bit window at bit  61 - 0.012%
...
Keyset 'Combination' - up to 20 blocks from a set of 2 - 2097150 keys
Testing collisions   - Expected     0.00, actual     0.00 ( 0.00x)
Testing distribution - Worst bias is the  18-bit window at bit  49 - 0.071%
...
Testing collisions   - Expected     0.00, actual     0.00 ( 0.00x)
Testing distribution - Worst bias is the  13-bit window at bit  26 - 0.356%
...
Testing collisions   - Expected     0.00, actual     0.00 ( 0.00x)
Testing distribution - Worst bias is the  17-bit window at bit  28 - 0.138%
