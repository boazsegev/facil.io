...
[facil.io](http://facil.io)'s core library is a three-file library (`fio-stl.h`, `fio.h` and `fio.c`), making it easy to incorporate networking solutions into any project.
