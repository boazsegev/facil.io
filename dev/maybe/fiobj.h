...
/**
 * Increases an object's reference count. A deep copy will be performed for
 * Arrays and Hashes, although non-collection types will be copied by reference.
 */
 ...
 */
void fiobj_each(fiobj_s *, int (*task)(fiobj_s *obj, fiobj_s *name, void *arg),
                void *arg);
...
/**
 * Return's a C String (NUL terminated) using the `fio_string_s` data type.
 *
